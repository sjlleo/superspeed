...
checkspeedtest() {
	if  [ ! -e './speedtest-cli/speedtest' ]; then
		...
		wget --no-check-certificate -qO speedtest.tgz https://github.com/user1121114685/speedtest_cli/raw/master/ookla-speedtest-1.0.0-$(uname -m)-linux.tgz > /dev/null 2>&1
	fi
